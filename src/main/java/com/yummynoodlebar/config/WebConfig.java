...
public class WebConfig extends WebMvcConfigurerAdapter
{
    ...
    /*
     * prepare a template resolver for html page display
     */
    @Bean
    ...
    /*
     * create a template engine based on a known template resolver
     */
    ...
    /*
     * return the Thymeleaf viewResolver with a known template resovler
     */
    @Bean
