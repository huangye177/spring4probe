...
/*
 * Specifies that a new instance of the bean will be created for every user session (HttpSession), 
 * and that this will be managed by an automatically generated proxy
 */
@Component
