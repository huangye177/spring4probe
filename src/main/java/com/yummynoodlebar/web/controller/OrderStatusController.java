...
public class OrderStatusController
{
    ...
    /*
     * When the page is rendered for the first time on a GET method, the method
     * getOrderStatus is called to generate the 'OrderStatus' property in the
     * model
     * 
     * The input parameter orderId is fetched from Controller's
