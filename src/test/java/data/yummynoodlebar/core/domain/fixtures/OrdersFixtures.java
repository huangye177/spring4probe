package data.yummynoodlebar.core.domain.fixtures;

import data.yummynoodlebar.core.domain.Ingredient;
import data.yummynoodlebar.core.domain.MenuItem;
import data.yummynoodlebar.core.domain.Order;
