...
public class CheckoutIntegrationTest
{
    ...
    /*
     * check the basket is correctly added to the model
     */
    @Test
    ...
    /*
     * check the view forward is correct
     */
    @Test
    ...
    /*
     * check the checkout controller will redirect to the url /order if the POST
    ...
    /*
     * check the checkout controller will forward back to the url /checkout if
    ...
    public void thatReturnsToCheckoutIfValidationFail() throws Exception
    {
        ...
        /*
         * NOTICE: TODO for unknown reason, the validation is not working with
         * latest Spring version for Unit test, but it works for UI
         */
